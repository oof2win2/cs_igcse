...
for turn in range(100):
    ...
    player_1.left(randint(-30, 30))
    player_2.forward(randint(1, 5))
    player_2.left(randint(-30, 30))
    player_3.forward(randint(1, 5))
    player_3.left(randint(-30, 30))
    player_4.forward(randint(1, 5))
    player_4.left(randint(-30, 30))
    player_5.forward(randint(5, 10))
    player_5.left(randint(-30, 30))
